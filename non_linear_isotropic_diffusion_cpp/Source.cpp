...
int main() {
    ...
    Data data_array[6];
    data_array[0].set_data("office_noisy.png", 1, "Question_1_t=1_d=1", 0.5);
    data_array[1].set_data("office_noisy.png", 1, "Question_1_t=5_d=1", 1);
    data_array[2].set_data("office_noisy.png", 1, "Question_1_t=10_d=1", 2);
    data_array[3].set_data("office_noisy.png", 1, "Question_1_t=30_d=1", 5);
    data_array[4].set_data("office_noisy.png", 1, "Question_1_t=100_d=1", 10);
    data_array[5].set_data("office_noisy.png", 1, "Question_2_d=1_t=10", 50);
